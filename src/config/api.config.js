...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    LOGIN: {
      ...
      EDITDATASUBSCRIPTIONPACKAGE:(id) =>  `/api/admin/subscription-packages/${id}`,
      GETALLUSERS:  "/api/admin/get_all_users",
      GETALLUSERSID:(id) =>  `/api/admin/users/${id}`,
      VERFICATIONSTATUS: "/api/admin/verification-status",
      REPORTEDFLAG: "api/admin/reported-users/flag",
      UNREPORTEDFLAG: (id) => `/api/admin/users/${id}/unflag`,
      BANNEDUSER: "/api/admin/users/ban",
      UNBANNEDUSER:(id) => `/api/admin/users/${id}/unban`,
      SAVEFAQ: "/api/admin/faqs",
      EDITFAQ:(id) => `/api/admin/faqs/${id}`,
      GETFAQ: "/api/admin/faqs",
      DELETEFAQ:(id) => `/api/admin/faqs/${id}`,
      ADDFAQ:(lang) => `/api/admin/faqs/create?lang=${lang}`,
