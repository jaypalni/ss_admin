...
const tabItems = [ { key: "arabic", label: ( <div style={{ display: "flex", alignItems: "center", gap: 6 }}> <img src={bluelogo_icon1} alt="Arabic Icon" style={{ width: 12, height: 12, filter: activeTab === "arabic" ? "invert(36%) sepia(89%) saturate(747%) hue-rotate(188deg) brightness(95%) contrast(90%)" : "grayscale(100%)", transition: "0.3s", }} /> <span style={{ color: activeTab === "arabic" ? "#008AD5" : "#4B5563", fontWeight: activeTab === "arabic" ? 500 : 500, }} > Arabic </span> </div> ), }, { key: "english", label: ( <div style={{ display: "flex", alignItems: "center", gap: 6 }}> <img src={bluelogo_icon1} alt="English Icon" style={{ width: 12, height: 12, filter: activeTab === "english" ? "invert(36%) sepia(89%) saturate(747%) hue-rotate(188deg) brightness(95%) contrast(90%)" : "grayscale(100%)", transition: "0.3s", }} /> <span style={{ color: activeTab === "english" ? "#008AD5" : "#4B5563", fontWeight: activeTab === "english" ? 500 : 500, }} > English </span> </div> ), }, { key: "kurdish", label: ( <div style={{ display: "flex", alignItems: "center", gap: 6 }}> <img src={bluelogo_icon1} alt="Kurdish Icon" style={{ width: 12, height: 12, filter: activeTab === "kurdish" ? "invert(36%) sepia(89%) saturate(747%) hue-rotate(188deg) brightness(95%) contrast(90%)" : "grayscale(100%)", transition: "0.3s", }} /> <span style={{ color: activeTab === "kurdish" ? "#008AD5" : "#4B5563", fontWeight: activeTab === "kurdish" ? 500 : 500, }} > Kurdish </span> </div> ), }, ];
